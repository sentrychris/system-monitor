...
<template>
  <div class="section-header">
    <div class="d-flex align-items-center gap-3">
      <div v-if="icon" class="header-icon" :class="`tone-${tone}`">
